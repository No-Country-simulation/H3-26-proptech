...
class Personal_Info(models.Model):
    ...
    financial_info_id = models.ForeignKey(
        'Financial_Info', on_delete=models.CASCADE, blank=True, null=True)
    credit_simulation_id = models.ForeignKey(
        'Credit_Simulation', on_delete=models.CASCADE, blank=True, null=True)
...
class Financial_Info(models.Model):
    ...
    guarantee_id = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='guarantee', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
